...
invalid_transid_all <- c(
  ...
  # 2024-05-07 Hull - agreed to cancel all old submissions (except those with smoking cessation)
  140089,142110,145405,146378,148303,150483,154350,156613,158862,162770,166772,
  171187,174474,178204,181011,182807,186013,188743,191715,194036,199747,199753,
  201521,204048,207752,211447,217873,221067,227941,232667,234969,238432,243326,
  247015,251248,
